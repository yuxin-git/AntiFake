package com.example.antifake.qrscan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barcodeScannerView.setTorchListener(new DecoratedBarcodeView.TorchListener() {
            ...
            public void onTorchOn() {
                buttonLed.setBackground(getResources().getDrawable(R.drawable.ic_flashlight_on));
                bTorch = true;
            }

            @Override
            public void onTorchOff() {
                buttonLed.setBackground(getResources().getDrawable(R.drawable.ic_flashlight_off));
                bTorch = false;
            }
        });
